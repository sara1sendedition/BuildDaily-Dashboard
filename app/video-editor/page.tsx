...
export default function VideoEditorPage() {
  ...
  const editorQueueHasActiveWork = editorQueue.some(
  ...
  useEffect(() => {
    ...
    if (shortJobPreviewEligible && shortJobId && shortReprocessBusy) {
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 pb-24">
      ...
      <div className="grid gap-8 lg:grid-cols-3 lg:gap-8">
        <div className="min-w-0 space-y-3 lg:col-span-1">
          ...
          <DriveInboxPanel
            onEnqueueFiles={(files, opts) => enqueueShortOnly(files, opts)}
            disabled={editorQueueHasActiveWork}
          />
